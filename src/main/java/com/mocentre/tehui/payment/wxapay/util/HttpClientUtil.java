package com.mocentre.tehui.payment.wxapay.util;
...
public class HttpClientUtil {
     ...
     * @throws UnrecoverableKeyException
     */
    public static SSLContext getSSLContext(FileInputStream keyFileInputStream, String keyPasswd)
            throws KeyStoreException, NoSuchAlgorithmException, CertificateException, IOException,
        ...
        SSLContext ctx = SSLContexts.custom().loadKeyMaterial(ks, kp).build();
        return ctx;
    }
