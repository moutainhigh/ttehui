package com.mocentre.tehui.payment.wxapay.client;
...
import com.mocentre.tehui.payment.wxapay.util.HttpClientUtil;

/**
 * 商户http或者https网络通信客户端<br/>
 * ========================================================================<br/>
 * api说明：<br/>
...
public class TenpayHttpClient {
    ...
    protected void callHttps() throws IOException, CertificateException, KeyStoreException, NoSuchAlgorithmException,
        ...
        SSLContext sslContext = HttpClientUtil.getSSLContext(keyStream, this.certPasswd);
